        				...
        				<div class="tab__container">
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
								...
								<div class="account__form">
	        						...
	        						<div class="input__box"><input class="new-product-field" type="text" name="id" placeholder="Product id"></div>
									<div class="input__box"><input class="new-product-field" type="text" name="name" placeholder="Product name"></div>
									<div class="input__box"><input class="new-product-field" type="text" name="type" placeholder="Product type"></div>
									<div class="input__box"><textarea class="new-product-field" name="description" placeholder="Product description"></textarea></div>
									<div class="input__box"><input class="new-product-field" type="text" name="price" placeholder="Product price"></div>
		        					<!-- End Single Product -->
