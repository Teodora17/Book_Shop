        		...
        		<div class="row">
        			<div class="col-lg-6 col-12">
        				<div class="customer_details">
        					...
        					<button type="submit" value="Submit">Order</button></br>
        				...
        				<div class="wn__order__box">
        					...
        					<c:forEach var="p" items="${sessionScope.orderedProducts}">
        						<ul class="order_product">
        							<li>${p.getName()} x ${p.getQuantity()}<span>$${Math.round(p.getUnitPrice() * p.getQuantity() * 100.0) / 100.0}</span></li>
        						</ul>
        					</c:forEach>
        					
        					<ul class="shipping__method">
        						<li>Cart Subtotal <span>$ ${Math.round(sessionScope.totalPrice * 100.0) / 100.0} </span></li>
        						<li>Shipping 
        							<ul>
        								<li>
        									<input name="shipping_method[0]" data-index="0" value="legacy_flat_rate" checked="checked" type="radio">
        									<label>Flat Rate: $ ${Math.round(sessionScope.totalPrice * 100.0) / 100.0} </label>
        								</li>
        								<li>
        									<input name="shipping_method[0]" data-index="0" value="legacy_flat_rate" checked="checked" type="radio">
        									<label>Flat Rate: $ ${Math.round(sessionScope.totalPrice * 100.0) / 100.0} </label>
        					...
        					<ul class="total__amount">
        						<li>Order Total <span>$ ${Math.round(sessionScope.totalPrice * 100.0) / 100.0} </span></li>
        					</ul>
        				</div>
