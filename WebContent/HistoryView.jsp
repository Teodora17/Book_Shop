...
<body>
	...
	<div class="wrapper" id="wrapper">
        ...
        <h3 style="margin-left:12.5cm;"> <%= message %> </h3>
        		...
        		<div class="row">
        			...
        			<div class="col-lg-9 col-12 order-1 order-lg-2">
        				...
        				<div class="tab__container">
		        			...
		        			<c:forEach var="product" items="${applicationScope.purchases}">
						
							<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
								<div class="product__thumb"> 
									<a class="first__img" href="single-product.html"></a> 
								...
								<div class="product__content content--center">
									...
									<ul> 
										<li class="old_prize"> Total price: ${product.getTotalPrice()} </li>
									</ul>
							<c:if test="${not empty sessionScope.User}">
								<ul> 
									<li> Quantity: ${product.getNumberOfItems()} </li> 
									<li> User: ${product.getUsername()} </li>
								</ul>
							</c:if>
							<div class="action">
							</div>
