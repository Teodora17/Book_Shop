...
<body>
	...
	<div class="wrapper" id="wrapper">
        ...
        <h3 style="margin-left:12.5cm;">  </h3>
        				...
        				<div class="row">
        					...
        					<div class="col-lg-12">
								<div class="shop__list__wrapper d-flex flex-wrap flex-md-nowrap justify-content-between">
			                        ...
			                        <p>Showing 1 to 12 of 40 results</p>
        				...
        				<div class="tab__container">
							...
							<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
								<div class="product__thumb"> 
									<a class="first__img" href="single-product.html"><img src="images/books/${Integer.toString(product.getId())}.jpg" alt="product image"></a> 
									<a class="second__img animation1" href="single-product.html"><img src="images/books/${Integer.toString(product.getId())}.jpg" alt="product image"></a>
									<div class="hot__box">
										<span class="hot-label">BEST SELLER</span>
									</div>
								</div><br>
								<div class="product__content content--center">
									<h4><a href="single-product.html">${product.getName()}</a></h4>
									<ul class="prize d-flex"> 
										<li>${product.getUnitPrice()}</li> 
										<li class="old_prize">$35.00</li>
									</ul>
							<c:if test="${not empty sessionScope.User}">
								Quantity <input type="number" name="product_${product.getId()}" />
							</c:if>
							<div class="action">
												<div class="actions_inner">
													<ul class="add_to_links">
														<li><a class="cart" href="cart.html"><i>Cart</i></a></li>
														<li><a class="wishlist" href="wishlist.html"><i>Wis</i></a></li>
														<li><a class="compare" href="#"><i>Co</i></a></li>
														<li><a data-toggle="modal" title="Quick View" class="quickview modal-view detail-link" href="#productmodal"><i>QuV</i></a></li>
													</ul><br>
												</div>
							</div>
